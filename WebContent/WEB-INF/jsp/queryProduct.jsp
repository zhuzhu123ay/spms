				...
				<c:forEach items="${list }" var="product">
					<tr>
						...
						<td><a class="text-danger glyphicon glyphicon-remove"
							href="dropProduct?productId=${product.productId }"></a> 
							<a class="text-success glyphicon glyphicon-refresh"
							href="toUpdateProduct?productId=${product.productId }"></a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
